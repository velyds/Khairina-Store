function tagin(el, option = {}) {
    const classElement = "tagin",
        ...
        defaultPlaceholder = "",
        separator =
            el.dataset.separator || option.separator || defaultSeparator,
        duplicate =
            el.dataset.duplicate || option.duplicate || defaultDuplicate,
        transform =
    ...
    const wrapper = el.nextElementSibling,
        ...
        getTags = () =>
            [...wrapper.getElementsByClassName(classTag)].map(
                (e) => e.textContent
            ),
    ...
    function updateTag() {
        getValue() !== getTag() &&
            ([...wrapper.getElementsByClassName(classTag)].map((e) =>
                e.remove()
            ),
            "" !== getValue().trim() &&
                input.insertAdjacentHTML(
    ...
    wrapper.addEventListener("click", () => input.focus()),
        ...
        input.addEventListener("keydown", (e) => {
            "" === input.value &&
                ...
                (wrapper
                    .querySelector("." + classTag + ":last-of-type")
                    .remove(),
                updateValue());
        }),
